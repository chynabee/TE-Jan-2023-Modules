...
public class JdbcCityDaoTests extends BaseDaoTests {
    ...
    public void getCity_returns_correct_city_for_id() {
        ...
        //Arrange - done in the setup method and also in declaring those constants

        //Act - calling the method that we want to test and storing the result
        City city = sut.getCity(1);

        //Assert - Making sure that what we got as a result, matches what we expected
