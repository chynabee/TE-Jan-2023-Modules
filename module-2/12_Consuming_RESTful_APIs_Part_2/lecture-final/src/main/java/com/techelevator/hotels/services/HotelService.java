...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
         ...
         //Any time that we are doing a post or put we will create these headers
        // and indicate that the content type is of json format
        ...
        //The data type in the carrots always represents what data type we are sending
        HttpEntity<Reservation> request = new HttpEntity<>(newReservation, headers);

        //Instead of the getForObject now we'll use the postForObject to do the post
