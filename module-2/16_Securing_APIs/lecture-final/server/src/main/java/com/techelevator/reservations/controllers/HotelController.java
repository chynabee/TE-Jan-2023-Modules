...
// isAuthenticated() = means that we are verifying the user has logged in
...
public class HotelController {
 ...
 /**
     ...
     */
 //permitAll - means that the user does not need to be logged in to get this data
     ...
     * @param id
     */
    // hasRole('ADMIN')  - indicates individual role we want to give permission to
    //hasAnyRole('ADMIN','USER') - indicates multiple roles that we want to give permission to
