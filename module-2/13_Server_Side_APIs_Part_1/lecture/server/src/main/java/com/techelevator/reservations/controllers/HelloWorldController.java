...
public class HelloWorldController {
    ...
    //when we recieve a request, we are going to check the url and see if it
    ...
    public String greetPeople(@RequestParam(defaultValue = "Chy", value = "person1") String firstPerson,
