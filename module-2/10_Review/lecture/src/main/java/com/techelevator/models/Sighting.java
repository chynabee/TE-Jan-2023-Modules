...
public class Sighting {
    ...
    private String identificationExplanation;
    ...
    public String getIdentificationExplanation() {
        return identificationExplanation;
    }

    public void setIdentificationExplanation(String identificationExplanation) {
        this.identificationExplanation = identificationExplanation;
    }
