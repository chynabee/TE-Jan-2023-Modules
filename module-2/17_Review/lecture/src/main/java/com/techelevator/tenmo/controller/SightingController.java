...
//First thing to do with any controller is to indicate to Spring that it is a controller-@RestController
@RestController
public class SightingController {

    //instead of declaring a new dao, have spring wire it up for you
    //use the autowired @AutoWired annotation here and make sure the dao itself has
    //the component annotation on it
    @Autowired
