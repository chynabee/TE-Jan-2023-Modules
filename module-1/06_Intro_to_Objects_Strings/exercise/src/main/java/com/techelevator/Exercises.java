...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String makeOutWordString = out + word + out;
		String firstPartOfString = out.substring(0, 2);
		String secondPartOfString = out.substring(2);
		return firstPartOfString + word + secondPartOfString;
	...
	public String firstTwo(String str) {
		...
		if (str.length() <= 1) {
			...
			String firstCoupleLetters = str.substring(0, 2);
			return firstCoupleLetters;
		}
	}
	...
	public String right2(String str) {
		...
		return one + str.substring(0, str.length()-2);
	...
	public String twoChar(String str, int n) {
		...
		if(str.length() == n || str.length()-2 < n) {
			answer = str.substring(0, 2);
			return answer;
		}
		//String lastTwoChar = str.substring(str.length()-2);
		answer = str.substring(n, n+2);
		return answer;
	}
	...
	public boolean hasBad(String str) {
		...
		//if bad starts at 0 or 1, return true
		// else return false
	...
	public int last2(String str) {
		...
		//when we pass in only one argument to substring, that's the index we begin at
		//and then we take the rest of the string until the end
		...
		for(int i = 0; i < str.length() - 2; i++) {
			...
			//if we pass 2 arguments to substring, we are indicating both the start and the end
			//go up until this index but do not include it
			String current2 = str.substring(i, i+2);

			if(lastTwoChar.equals(current2)) {
				counter++;
			}
